    ...
    function validation()
        {
            ...
            var lpass = document.forms["myForm"]["password"].value;
                                            ...
                                            <div class="col-md-12">
                                                <div class="travel-login ">
                                                    ...
                                                    <div class="text-felid label-effect margin-bottom-30">
                                                        ...
                                                        <div class="kf_felids">
                                                            <input class="ipd" type="email" data-new-placeholder=" E-mail" placeholder="Enter your E-mail" name="email">
                                                        </div>  
                                                    </div>
                                                    ...
                                                    <div class="form-btn">
                                                        <input class="submit-btn" type="submit" name="submit" value="Login" onclick="validation()" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
