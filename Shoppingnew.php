        ...
        <div class="content">
            ...
            $query = "SELECT * FROM tbl_city ";  
             ...
             ?>
                                         ...
                                         <li><a href="shop_cities.php?id=<?php echo $city_id; ?>"><?php echo $city_name; ?></a></li>
                                       <?php
                    }
                }
?>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="kf_post_2 kf_post">
                                        ...
                                        <div class="kf_post_content">
                                            <h6><?php echo $shopname; ?></h6>
                                            <ul class="meta_tag">
                                                <li><span class="fa fa-calendar"></span><a href="#"><?php echo $shoptime; ?></a></li>
                                                                                            </ul>
                                           <p><?php echo $shopadd; ?></p>
                                           <a class="btn-normal-1 " href="Shopping_details.php?id=<?php echo $id;?>" style="margin-left: 40px; margin-top: 20px;  background-color:orange;">SEE MORE</a>
                                        </div>
