			...
			<div class="kode_banner">
				...
				<div class="sub-banner">
					<div class="container">
						...
						?>
					<div class="container">
						<h2>Hospitals in <?php echo $city_name ; ?></h2>
					</div>
					<?php
									}
								}
				...
				<section>
					<div class="container">
						...
						<div class="destination-blog-01">
							<div class="row">
								<?php
							$query="SELECT * FROM tbl_hospital where city_id=$city_id";
							$result=mysqli_query($conn,$query);
							if($result->num_rows!=0)
							{
								while($row=$result->fetch_array())
						...
						?>
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="destination-grid">
										<img src="<?php echo $himg; ?>" alt="img here" style="height: 300px; width: 500px;">
										<div class="destination-grid-content">
											<h5><a href="#"><?php echo $hname; ?></a></h5>
											<span></span>
											<br><br><br><br>
											<!--<p><?php //echo $hdesc; ?></p>-->
											<a href="Hospital_details.php?id=<?php echo $id;?>" class="arrow-btn">See More</a>
										</div>
									</div>
								</div>
								<?php
