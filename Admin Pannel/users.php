                ...
                {  
                  ...
                  ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#"><span class="list-enq-name"><?php echo $reg_name;?></span>
                                                        <!--<span class="list-enq-city">Illunois, United States</span>--></a>
                                                    </td>
                                                    <td><?php echo $reg_contact;?></td>
                                                    <td><?php echo $reg_email;?></td>
                                                    <td><?php echo $reg_password;?></td>
                                                    <td>
                                                      <!--  <span class="label label-primary">02</span>-->
                                                      <?php echo $reg_city;?>
                                                    </td>
                                                    <td><?php echo $reg_state;?></td>
                                                    <td><a href=user-view.php?update_=$row[c_id]>
