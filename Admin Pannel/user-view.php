<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://rn53themes.net/themes/demo/lava-admin/user-view.html by Cyotek WebCopy 1.7.0.600, Monday, September 9, 2019, 6:42:26 PM -->
        ...
        <div class="row">
            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-3">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp" style="width: 850px; margin-left:  60px;">
                                <div class="inn-title">
         ...
         <?php
            ...
            $query = "SELECT * FROM tbl_registration where reg_id=1 ";  
                ...
                {  
                  ...
                  ?>
                                            ...
                                            <div class="input-field col s6">
                                                <input id="first_name" type="text" value="<?php echo $row['reg_name']; ?>" class="validate">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="phone" type="text" value="<?php echo $row['reg_contact']; ?>" class="validate">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="city" type="text" value="<?php echo $row['reg_city']; ?>" class="validate">
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input id="country" type="text" value="<?php echo $row['reg_state']; ?>" class="validate">
                                                <label for="country">State</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="password" type="text" value="<?php echo $row['reg_password']; ?>" class="validate">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="email" type="email" value="<?php echo $row['reg_email']; ?>"" class="validate">
