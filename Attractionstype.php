        ...
        <div class="content">
            ...
            $query = "SELECT * FROM tbl_city ";  
             ...
             ?>
                                         ...
                                         <li><a href="Attractions_cities.php?id=<?php echo $city_id; ?>"><?php echo $city_name; ?></a></li>
                                       <?php
                    }
                }
?>
                        ...
                        <div class="col-md-8">
                        	...
                        	<?php
                            $query="SELECT * FROM tbl_attractions where t_id=$id1";
                            $result=mysqli_query($conn,$query);
                            if($result->num_rows!=0)
                            {
                                while($row=$result->fetch_array())
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12" >
                                    <div class="kf_post_2 kf_post" >
                                        <div class="zoom-picture1 height-239">
                                            <img src="<?php echo $aimg; ?>" alt="blog img" style="height:200px;">
                                        </div>
                                        <div class="kf_post_content">
                                            <h6><?php echo $aname; ?></h6>
                                            <ul class="meta_tag">
                                                <li><span class="fa fa-calendar"></span><a href="#"><?php echo $atime; ?></a></li>
                                                <!--<li><span class="fa fa-tags"></span><a href="#"><?php //echo $shoptime; ?></a></li>-->
                                            </ul>
                                           <p><?php echo $aadd; ?></p>

                                            <a class="btn-normal-1 " href="Attraction_details.php?id=<?php echo $id;?>" style="margin-left: 40px; margin-top: 20px;  background-color:orange;">SEE MORE</a>
                                        </div>
                                         </div>
                                </div>
