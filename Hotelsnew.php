        ...
        <div class="content">
            ...
            $query = "SELECT * FROM tbl_city ";  
             ...
             ?>
                                         ...
                                         <li><a href="Hotels_cities.php?id=<?php echo $city_id; ?>"><?php echo $city_name; ?></a></li>
<?php
}
} 
?>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="kf_post_2 kf_post">
                                        ...
                                        <div class="kf_post_content">
                                           ...
                                           <p><?php echo $radd; ?></p>
                                           <a class="btn-normal-1 " href="Hotel_details.php?id=<?php echo $id;?>" style="margin-left: 40px; margin-top: 20px;  background-color:orange;">SEE MORE</a>
                                        </div>
