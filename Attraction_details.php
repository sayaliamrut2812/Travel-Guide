	...
	<body >
		...
		?>
			...
			<div class="kode_banner">
				<?php
							$query="SELECT * FROM tbl_attractions where a_id=$id";
							...
							if($result->num_rows!=0)
							{
								while($row=$result->fetch_array())
								{
									...
									$a_desc=$row['a_desc'];
								    $a_img=$row['a_image'];
								    $a_time=$row['a_timings'];

						?>
				<!--Sub banner for inner pages-->
				<div class="kode_destination_banner overlay-30" style="background-image: url(<?php echo $a_img?>);  >
				<?php }}?>
					...
					<div class="container">
						...
						<div class="kode_tour_caption">
							...
							<h2 style="font-size: 45px;"><?php echo $a_name;?></h2>
				...
				<div class="kode_portfolio_info">
					...
					<section class="kf_culture_section" id="scroll1" >
						...
						?>
								...
								<span>About</span>
																<h2 style="font-size: "><?php echo $a_name;?></h2>
							</div>
							<div class="kf_culture_blog">
								...
								<div class="kf_culture_pictures">
									<figure>
										<div class="thumb1">
											<img src="images/attr1.jpg" alt="image here">
										</div>
										<div class="thumb2">
											<img src="images/attr2.jpg" alt="image here">
										</div>
									</figure>
								</div>
							</div>
							...
							<div class="kode_history_content">
								...
								<div class="kode-accordian-blog">
									...
									<div class="accordian-content">
										<b><h5>Address: </h5></b>
										<p><?php echo $a_address=$row['a_address'];?></p>
										<b><h5>Timings: </h5></b>
										<p><?php echo $a_time=$row['a_timings'];?></p>
									</div>
