	...
	<body >
		...
		?>
			...
			<div class="kode_banner">
				<?php
							$query="SELECT * FROM tbl_hospital where h_id=$id";
							...
							if($result->num_rows!=0)
							{
								while($row=$result->fetch_array())
								{
									...
									$h_desc=$row['h_desc'];
								    $h_img=$row['h_image'];
								    $h_time=$row['h_timings'];

						?>
				<!--Sub banner for inner pages-->
				<div class="kode_destination_banner overlay-30" style="background-image: url(<?php echo $h_img?>);  >
				<?php }}?>
						...
						<?php
							...
							if($result->num_rows!=0)
							{
								while($row=$result->fetch_array())
								{
								    ...
								    $h_img=$row['h_image'];
								    $h_time=$row['h_timings'];
								    $h_cont=$row['h_contact'];
								    $h_rate=$row['h_ratings'];
								    $h_web=$row['h_website'];
						?>
					
						<div class="kode_tour_caption">
							
							<h2 style="font-size: 45px;"><?php echo $h_name;?></h2>
				...
				<div class="kode_portfolio_info">
					...
					<section class="kf_culture_section" id="scroll1">
						...
						?>
								...
								<span>About</span>
								<h2 style="font-size: "><?php echo $h_name;?></h2>
							</div>
							<div class="kf_culture_blog">
								...
								<div class="kf_culture_pictures">
									<figure>
										<div class="thumb1">
											<img src="images/hosp1.jpg" alt="image here">
										</div>
										<div class="thumb2">
											<img src="images/hosp2.jpg" alt="image here">
										</div>
									</figure>
								</div>
							</div>
							...
							<div class="kode_history_content">
								...
								<div class="kode-accordian-blog">
									...
									<div class="accordian-content">
										<b><h5>Address: </h5></b>
										<p><?php echo $h_address=$row['h_address'];?></p>
										<b><h5>Timings: </h5></b>
										<p><?php echo $h_time=$row['h_timings'];?></p>
										<b><h5>Contact: </h5></b>
										<p><?php echo $h_cont=$row['h_contact'];?></p>
										<b><h5>Website: </h5></b>
										<p><?php echo $h_web=$row['h_website'];?></p>
										<b><h5>Ratings: </h5></b>
