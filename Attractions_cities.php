			...
			<div class="kode_banner">
				...
				<div class="sub-banner">
					<?php
						...
						?>
					<div class="container">
						<h2>Places of Attractions in <br><br><?php echo $city_name ; ?></h2>
					</div>
					<?php
									}
								}
				...
				<section>
					<div class="container">
						...
						<div class="destination-blog-01">
							<div class="row">
								<?php
							$query="SELECT * FROM tbl_attractions where city_id=$city_id";
							$result=mysqli_query($conn,$query);
							if($result->num_rows!=0)
							{
								while($row=$result->fetch_array())
						...
						?>
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="destination-grid">
										<img src="<?php echo $aimg; ?>" alt="img here" style="height: 300px; width: 500px;">
										<div class="destination-grid-content">
											<h5  ><a href="#"><?php echo $aname; ?></a></h5>
											<br><br><br><br>
											<a href="Attraction_details.php?id=<?php echo $id;?>" class="arrow-btn">See More</a>
										</div>
									</div>
								</div>
								<?php
